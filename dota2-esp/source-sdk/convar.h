...
{
public:
	virtual int  CommandCompletionCallback( const char *pPartial, int &commands ) = 0;
};
...
public:
	...
	virtual int AutoCompleteSuggest( const char *partial, int &commands );
...
public:
	...
	int GetChangeCallbackCount() const { return 0;/*m_pParent->m_fnChangeCallbacks.Count();*/ }
	FnChangeCallback_t GetChangeCallback( int slot ) const { return NULL;/*m_pParent->m_fnChangeCallbacks[ slot ];*/ }

	// Retrieve value
	virtual float				GetFloat( void ) const;
	virtual int				GetInt( void ) const;
	FORCEINLINE_CVAR int			GetColor( void ) const;
...
private:
	...
	virtual void				InternalSetColorValue( int value );
...
// Output : Color
//-----------------------------------------------------------------------------
FORCEINLINE_CVAR int ConVar::GetColor( void ) const 
{
#ifdef CONVAR_TEST_MATERIAL_THREAD_CONVARS
	Assert( ThreadInMainThread() || IsFlagSet( FCVAR_MATERIAL_THREAD_MASK | FCVAR_ACCESSIBLE_FROM_THREADS ) );
#endif
	unsigned char *pColorElement = ((unsigned char *)&m_pParent->m_Value.m_nValue);
	return NULL/*int( pColorElement[0], pColorElement[1], pColorElement[2], pColorElement[3] )*/;
}
...
// Purpose: Return ConVar value as a color
//-----------------------------------------------------------------------------
FORCEINLINE_CVAR int ConVarRef::GetColor( void ) const 
{
...
FORCEINLINE_CVAR void ConVarRef::SetValue( )
{
	m_pConVar->SetValue(  );
}
...
// Purpose: Return ConVar value as an int
//-----------------------------------------------------------------------------
FORCEINLINE_CVAR int SplitScreenConVarRef::GetColor( int nSlot ) const 
{
...
{
	m_Info[ nSlot ].m_pConVar->SetValue(  );
}
...
class CConCommandMemberAccessor : public ConCommand, public ICommandCallback, public ICommandCompletionCallback
{
	...
	typedef int  ( T::*FnMemberCommandCompletionCallback_t )( const char *pPartial, int &commands );
...
public:
	...
	virtual int  CommandCompletionCallback( const char *pPartial, int &commands )
	{
